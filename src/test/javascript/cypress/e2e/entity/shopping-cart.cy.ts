...
describe('ShoppingCart e2e test', () => {
  ...
  // const shoppingCartSample = {"placedDate":"2022-12-15T09:48:39.162Z","status":"COMPLETED","totalPrice":33864,"paymentMethod":"CREDIT_CARD"};
  ...
  describe('new ShoppingCart page', () => {
    ...
    it.skip('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-12-16T03:20').blur().should('have.value', '2022-12-16T03:20');
